...
const en: Dict = {
  chips: ["Career & Wealth", "Marriage & Love Life", "Health Analysis", "Sade Sati Status"],
...
const hi: Dict = {
  chips: ["करियर और धन", "विवाह और प्रेम", "स्वास्थ्य विश्लेषण", "साढ़े साती स्थिति"],
  greeting: (fn, sign, nak, pob) =>
...
const bn: Dict = {
  chips: ["কর্মজীবন ও সম্পদ", "বিবাহ ও প্রেম", "স্বাস্থ্য বিশ্লেষণ", "সাড়ে সাতি অবস্থা"],
  greeting: (fn, sign, nak, pob) =>
...
const te: Dict = {
  chips: ["వృత్తి & సంపద", "వివాహం & ప్రేమ", "ఆరోగ్య విశ్లేషణ", "సాడే సతి స్థితి"],
  greeting: (fn, sign, nak, pob) =>
...
const mr: Dict = {
  chips: ["करिअर व संपत्ती", "विवाह व प्रेम", "आरोग्य विश्लेषण", "साडेसाती स्थिती"],
  greeting: (fn, sign, nak, pob) =>
...
const gu: Dict = {
  chips: ["કારકિર્દી અને ધન", "લગ્ન અને પ્રેમ", "આરોગ્ય વિશ્લેષણ", "સાડાસાતી સ્થિતિ"],
  greeting: (fn, sign, nak, pob) =>
...
const kn: Dict = {
  chips: ["ವೃತ್ತಿ ಮತ್ತು ಸಂಪತ್ತು", "ವಿವಾಹ ಮತ್ತು ಪ್ರೇಮ", "ಆರೋಗ್ಯ ವಿಶ್ಲೇಷಣೆ", "ಸಾಡೇ ಸತಿ ಸ್ಥಿತಿ"],
  greeting: (fn, sign, nak, pob) =>
